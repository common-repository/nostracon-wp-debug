...
class WP_Config_Manager extends File_Manager {
	...
	public function amend_wp_config_php_with_debug_variables () {
		
		
		// The params we are after are WP_DEBUG, WP_DEBUG_LOG, WP_DEBUG_DISPLAY, SCRIPT_DEBUG and SAVEQUERIES
		
		// For each of the parameters above, find out if any can be found in wp_config.php
		...
		// At this point, only WP_DEBUG should be left in the wp_config.php file.
